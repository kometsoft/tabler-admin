        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-actions">
                    <x-tabler::button type="submit" form="form-user-edit" class="btn btn-primary" icon="check" label="Save"></x-tabler::button>
                </div>
            </div>
            <div class="card-body">
                <form id="form-user-edit"
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-md-9">
                            <x-tabler::input type="email" name="email" :value="old('email', $user->email)" required></x-tabler::input>
                        </div>
                    </div>
